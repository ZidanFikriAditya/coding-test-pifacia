...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto px-4 py-8">
            <div class="mb-4">
                <h1 class="text-2xl font-bold">Create Participant</h1>
                <p>This form to create participant</p>
            </div>
                ...
                <div class="mt-5 grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        <div
                            ...
                            v-for="(extraData, index) in extraDatas"
                        ...
                        >
                            <div class="col-span-3">
                                ...
                                <Input
                                    ...
                                    @update:model-value="
                                        (value) => (extraDatas[index] = { ...extraDatas[index], value: value.toString() })
                                    "
                            ...
                            <div class="col-span-1 inline-flex items-center gap-2">
                                ...
                                <Button
                                    type="button"
                                    v-if="extraDatas.length > 1"
                                    @click="extraDatas.splice(index, 1)"
                                    variant="destructive"
                                    ><Trash />
                                </Button>
                            </div>
